  ...
  render() {
    const columns = [
      ...
      },
      {
        ...
        cell: row => <>
          {row.img_slide != null ?
            <img src={this.state.url + row.img_slide} width="150" alt="" onClick={() => {
              this.dialog.show({
            ...
            :
            <img src={this.state.url + `/no-image.png`} width="100" alt="" onClick={() => {
              this.dialog.show({
                title: 'Ganti Gambar Slide',
                body: [<Formik key={row.id}
                  initialValues={{
                ...
                >
                  {({
                    ...
                    <Form onSubmit={handleSubmit}>
                      ...
                      <Form.Group className="mb-3">
                        <Form.Label>Gambar Slide</Form.Label><br />
                        <img src={this.state.url+`/no-image.png`} className="img-fluid" width="200" />
                      </Form.Group>
